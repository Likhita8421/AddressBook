...
namespace addressbook
{
    public class Person
    {
        ...
        {
            string path = @"C:\Users\hp\Documents\Repository\AddressBook_Day-9-10-27-28\AddressBook\AddressBook\ContactsFile.csv";
        ...
        {
            addmulticontacts();
            string path = @"C:\Users\hp\Documents\Repository\AddressBook_Day-9-10-27-28\AddressBook\AddressBook\ContactsFile.json";
